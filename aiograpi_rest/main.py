...
OPERATION_SUMMARIES = {
    ...
    "postAccountFollowRequestApprove": "Approve a pending follow request",
    "deleteAccountFollowRequest": "Decline a pending follow request",
    ...
    "getMediaCommentsStream": "Stream media comments",
    "postMediaComment": "Create a media comment",
    "deleteMediaComment": "Delete a media comment",
    "getMediaCommentInfos": "Get media comment summaries",
    "postMediaCommentCheckOffensive": "Check comment text for offensiveness",
    ...
    "getMediaCommentLikers": "List comment likers",
    "postMediaCommentPin": "Pin a media comment",
    "deleteMediaCommentPin": "Unpin a media comment",
    ...
    "getDirectThreads": "List direct threads",
    "getDirectThread": "Get direct thread details",
    "getDirectThreadByParticipants": "Find a direct thread by participants",
    "patchDirectThread": "Update direct thread state",
    "deleteDirectThread": "Hide a direct thread",
    "patchDirectThreadSeen": "Mark a direct thread as seen",
    "postDirectThreadMute": "Mute a direct thread",
    "deleteDirectThreadMute": "Unmute a direct thread",
    "postDirectThreadVideoCallMute": "Mute direct thread video calls",
    "deleteDirectThreadVideoCallMute": "Unmute direct thread video calls",
    "postDirectThread": "Create a direct thread",
    "postDirectThreadUser": "Add users to a direct thread",
    "getDirectMessages": "List direct thread messages",
    "getDirectMessagesSearch": "Search direct messages",
    "getDirectMessage": "Get a direct message",
    ...
    "postDirectMessageLike": "Like a direct message",
    "deleteDirectMessageLike": "Unlike a direct message",
    "postDirectMessageReaction": "React to a direct message",
    "deleteDirectMessageReaction": "Remove a direct message reaction",
    "getDirectPending": "List pending direct thread requests",
    "patchDirectPending": "Approve a pending direct thread request",
    "getDirectSearch": "Search direct recipients",
    "getDirectPresence": "Get direct presence",
    "getDirectMedia": "List direct thread media",
    "postDirectMedia": "Share media to direct users",
    "postDirectProfile": "Share a profile to direct users or threads",
    ...
    "postUserCloseFriend": "Add a user to close friends",
    "deleteUserCloseFriend": "Remove a user from close friends",
    ...
    "postUserNotificationsPosts": "Enable post notifications for a user",
    "deleteUserNotificationsPosts": "Disable post notifications for a user",
    "postUserNotificationsStories": "Enable story notifications for a user",
    "deleteUserNotificationsStories": "Disable story notifications for a user",
    "postUserNotificationsReels": "Enable Reel notifications for a user",
    "deleteUserNotificationsReels": "Disable Reel notifications for a user",
    "postUserNotificationsVideos": "Enable video notifications for a user",
    "deleteUserNotificationsVideos": "Disable video notifications for a user",
