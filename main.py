...
OPERATION_SUMMARIES = {
    ...
    "getDirectInbox": "List direct inbox threads",
    ...
    "getHashtagMediasTop": "List top hashtag media",
    "getHashtagMediasRecent": "List recent hashtag media",
    ...
    "getLocationMediasTop": "List top location media",
    "getLocationMediasRecent": "List recent location media",
    ...
    "getStoryViewers": "List story viewers",
    "getStoryArchive": "List story archive days",
    ...
    "getUserFollowRequests": "List pending follow requests",
